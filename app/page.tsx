...
const C:City[]=[
{id:"ven",name:"Venetie",region:"Veneto",color:"#1e3a5f",lat:45.4408,lng:12.3155,zoom:14,intro:"Drijvende droomstad. Gondels, San Marco, verdwalen in steegjes.",history:"Venetie werd gesticht in de 5e eeuw door vluchtelingen. Groeide uit tot machtige handelsrepubliek die het Byzantijnse Rijk, de kruistochten en de Renaissance domineerde. Het Dogenpaleis was 1000 jaar het centrum van de macht.",budget:"Venetie is duur. Reken op E15-25 voor lunch, E30-50 voor diner. Vaporetto dagpas E25. Vermijd restaurants direct aan San Marco.",safety:"Veilige stad. Let op zakkenrollers bij Rialto en San Marco. Water uit kraan is drinkbaar. Acqua alta (hoogwater) nov-feb.",bookings:["Dogenpaleis: palazzoducale.visitmuve.it","Burano vaporetto: actv.avmspa.it"],firstSteps:["Koop vaporetto dagpas bij station","Download Venezia Unica app","Water bij supermarkt niet op plein","Loop Rialto naar San Marco als eerste"],spots:[{name:"San Marco",desc:"Plein, basiliek, Dogenpaleis",tip:"Voor 9u gaan"},{name:"Rialto en Markt",desc:"Iconische brug + vismarkt",tip:"Markt 7:30-12:00"},{name:"Burano",desc:"Kleurrijkste eiland van lagune",tip:"Vaporetto 12, 45 min"},{name:"Dorsoduro",desc:"Rustigste wijk",tip:"Ponte Accademia bij sunset"}],restaurants:[{name:"Dal Moro's Fresh Pasta",type:"Pasta to-go",price:"E",tip:"Viral op TikTok, E7-10, carbonara of cacio e pepe"},{name:"Osteria Al Squero",type:"Cicchetti",price:"E",tip:"Spritz aan het water bij gondolwerf"},{name:"Bar All'Arco",type:"Cicchetti",price:"E",tip:"Beste baccala mantecato, cash only"},{name:"Bacareto da Lele",type:"Cicchetti",price:"E",tip:"Wijn E0.70, spritz E1.80! Cash only"},{name:"Cantine del Vino gia Schiavi",type:"Cicchetti",price:"E",tip:"Creatieve cicchetti, tonijn met cacao"},{name:"I Tre Mercanti",type:"Tiramisu",price:"E",tip:"Elk uur vers, pistache of Nutella E4.50"},{name:"Cantina Do Spade",type:"Venetiaans",price:"EE",tip:"Sinds 1488"}],viral:[{name:"Libreria Acqua Alta",desc:"Boekwinkel met boeken in gondels en badkuipen",tag:"@kellyprincewright 8.7K likes"},{name:"Burano regenbooghuisjes",desc:"Vaporetto 12, ga vroeg voor lege straten",tag:"@venice.explore"},{name:"Dal Moro's Flaming Cheese Wheel",desc:"Carbonara in Parmigiano wiel, geflambeerd aan tafel",tag:"@sarinasandco"},{name:"Scala Contarini del Bovolo",desc:"Verborgen spiraaltrappenhuis, 360 panorama E8",tag:"@tourleadervenice"},{name:"San Giorgio Maggiore belvedere",desc:"Skyline San Marco, sunset, bijna geen drukte E6",tag:"TikTok hidden gem"},{name:"Gelatoteca Suso",desc:"Beroemdste ijs van Venetie, Marosticana-smaak",tag:"@gelatoteca_suso"},{name:"Cicchetti-crawl route",desc:"Al Squero > Bar All'Arco > Da Lele > Schiavi",tag:"@officerdumpling"}],transport:["Vaporetto dagpas kopen","Alilaguna boot vanaf vliegveld","Alles te voet + vaporetto"]},
{id:"gar",name:"Gardameer",region:"Lombardije",color:"#1a4433",lat:45.65,lng:10.67,zoom:11,intro:"Grootste meer van Italie. Citroentuinen, bergen, Hotel Berta.",history:"Het Gardameer is al sinds de Romeinse tijd een vakantiebestemming. Catullus had hier een villa. Later verbleef Goethe en D'Annunzio hier. De Scaligeri bouwden kastelen langs de oevers.",budget:"Goedkoper dan Venetie. Lunch E10-18, diner E20-35. Veerboot dagpas ~E35. Parkeren kan lastig zijn in Sirmione.",safety:"Zeer veilig. Zwemmen in het meer is prima. Wegen langs westoever zijn smal en druk in het seizoen.",bookings:["Grotte di Catullo: grottedicatullo.beniculturali.it"],firstSteps:["Check in Hotel Berta","Huur boot of fiets bij haven","Download Navigarda app"],spots:[{name:"Sirmione",desc:"Kasteel + thermale bronnen",tip:"Grotte di Catullo"},{name:"Limone sul Garda",desc:"Citroentuinen + pittoresk",tip:"Limonaia del Castel"},{name:"Riva del Garda",desc:"Bergen + meer",tip:"Cascata del Varone"}],restaurants:[{name:"Al Pescatore",type:"Vis",price:"EE",tip:"Terras aan het water"},{name:"Terrazza del Brivido",type:"Restaurant",price:"EE",tip:"350m boven meer! Drankje verplicht E5-8"},{name:"Hostaria al Buongusto",type:"Italiaans",price:"EE",tip:"Droomterras achter bougainville, Limone"},{name:"Bella Napoli Riva",type:"Pizza",price:"E",tip:"Pizza + carbonara onder E15"},{name:"Osteria Il Gallo",type:"Lokaal",price:"E",tip:"Authentiek"}],viral:[{name:"Terrazza del Brivido",desc:"Betonnen terras 350m boven meer, POV-videos viral",tag:"@terrazzadelbrivido 14K"},{name:"Jamaica Beach Sirmione",desc:"Turquoise water, warmwaterbronnen, gratis",tag:"TikTok viral #lakegarda"},{name:"Ciclopista del Garda",desc:"Mooiste fietspad ter wereld, 50m boven meer, LED-verlicht",tag:"@travels.lau (NL)"},{name:"Lago di Tenno",desc:"Smaragdgroen meertje, verdwijnend eilandje",tag:"@travels.lau (NL)"},{name:"Monte Baldo Funivia",desc:"360 draaiende cabine naar 1760m, paragliding",tag:"TikTok viral"},{name:"Lido 84 Cacio e Pepe",desc:"Pasta gekookt in varkensblaas, World 50 Best #7",tag:"@ristorantelido84"},{name:"Strada della Forra",desc:"James Bond-route naar Tremosine, haarspeldbochten",tag:"#jamesbond"}],transport:["Veerboten: navigazionelaghi.it","Auto voor westoever","Trein: Desenzano station"]},
{id:"ver",name:"Verona",region:"Veneto",color:"#3a1e45",lat:45.4384,lng:10.9916,zoom:14,intro:"Shakespeare stad. Arena, Amarone, liefde overal.",history:"Verona was een belangrijke Romeinse stad (Arena uit 30 na Chr). Later heersten de Scaligeri, daarna Venetie. Shakespeare maakte het onsterfelijk met Romeo en Julia, al was het verhaal fictief.",budget:"Middenklasse. Lunch E10-20, diner E25-40. Verona Card E20/24u bespaart veel op musea. Wijn in Valpolicella is goedkoop.",safety:"Veilige, compacte stad. Arena-omgeving kan druk zijn. Pas op voor fietsen in het centrum.",bookings:["Arena di Verona: arena.it","Verona Card: veronacard.it"],firstSteps:["Station naar Piazza Bra 10 min","Koop Verona Card 24/48u","Arena buiten = gratis","Boek wijnproeverij Valpolicella"],spots:[{name:"Arena di Verona",desc:"Romeins amfitheater",tip:"arena.it voor opera"},{name:"Piazza delle Erbe",desc:"Markt + aperitivo",tip:"Torre dei Lamberti"},{name:"Castel San Pietro",desc:"Panorama over stad",tip:"15 min klimmen"},{name:"Ponte Pietra",desc:"Romeinse brug",tip:"Golden hour"},{name:"Valpolicella",desc:"Amarone wijnstreek",tip:"20 min rijden"}],restaurants:[{name:"La Bottega della Gina",type:"Pasta",price:"E",tip:"Viral TikTok! Verse pasta E8, truffel-pasta"},{name:"La Prosciutteria",type:"Charcuterie",price:"EE",tip:"Planken aan Piazza delle Erbe"},{name:"Mamma Cara Bistro",type:"Aperitivo",price:"E",tip:"Spritz + onbeperkt buffet E5! Wo-zo 18-21u"},{name:"Antica Bottega del Vino",type:"Wijnbar",price:"EE",tip:"180-pagina wijnlijst, Risotto all Amarone"},{name:"Osteria al Duca",type:"Veronees",price:"EE",tip:"Pastissada de caval"},{name:"Minuto di Bauli",type:"Bakkerij",price:"E",tip:"Viral pistachio brioche E3-5"},{name:"La Figaccia",type:"Focaccia",price:"E",tip:"Beste focaccia, take-away"}],viral:[{name:"La Bottega della Gina",desc:"Verse pasta door het raam zichtbaar, E8",tag:"@gotofoodpod 22K likes"},{name:"E5 Spritz + Buffet",desc:"Mamma Cara: spritz + onbeperkt eten voor E5",tag:"@laurabodini__ 8.1K likes"},{name:"Castel San Pietro sunset",desc:"Panorama over Verona, funicolare E2 omhoog",tag:"@kelseyinlondon 31K likes"},{name:"Ponte Pietra golden hour",desc:"Romeinse brug, trappen af naar rivier",tag:"TikTok viral"},{name:"Giardino Giusti",desc:"16e-eeuwse Renaissance-tuin met doolhof E10",tag:"Hidden gem"},{name:"Zeno Gelato",desc:"3 cones Gambero Rosso, Amarone-wijnijs!",tag:"@2foodtrippers"},{name:"Via Sottoriva",desc:"Middeleeuws straatje met portieken",tag:"TikTok outfit-content"}],transport:["Porta Nuova: Venetie/Milaan","Centrum = te voet","Bus naar Valpolicella"]},
{id:"tos",name:"Toscane",region:"Toscane",color:"#2a3518",lat:43.7696,lng:11.2558,zoom:10,intro:"Renaissance, cipressen, wijn. Firenze + droomdorpen.",history:"Toscane is de bakermat van de Renaissance. De Medici familie maakte Firenze tot cultureel centrum van Europa. Siena was eeuwenlang rivaal. Het landschap is al 500 jaar vrijwel onveranderd.",budget:"Firenze is prijzig, platteland goedkoper. Lunch E12-20, diner E25-45. Uffizi E25. Huurauto ~E50/dag. Agriturismo = beste waarde.",safety:"Zeer veilig. ZTL boetes in alle steden (E150+!). Wegen in Val d'Orcia zijn smal. Drinkwater uit kraan prima.",bookings:["Uffizi: uffizi.it/en/tickets","Duomo Firenze: duomo.firenze.it"],firstSteps:["Boek Uffizi WEKEN vooruit","Download Trenitalia app","Huur auto 1 dag Val d Orcia","ZTL = niet centrum inrijden!"],spots:[{name:"Uffizi",desc:"Botticelli, Da Vinci",tip:"Boek vooruit"},{name:"Ponte Vecchio",desc:"Gouden juweliersbrug",tip:"Sunset = goud"},{name:"San Gimignano",desc:"Torens + gelato",tip:"Dondero = kampioen"},{name:"Val d Orcia",desc:"Cipressen-foto",tip:"Auto huren"},{name:"Siena",desc:"Piazza del Campo",tip:"Compacter dan Firenze"},{name:"Piazzale Michelangelo",desc:"Uitzicht Firenze",tip:"Zonsondergang"}],restaurants:[{name:"All Antico Vinaio",type:"Panini",price:"E",tip:"1.6M TikTok likes! La Favolosa bestellen E5-8"},{name:"Trattoria Mario",type:"Florentijns",price:"E",tip:"Bistecca, communal seating, lunch only, cash"},{name:"Trattoria Sostanza",type:"Florentijns",price:"EE",tip:"Viral boterkip + artisjok-omelet, cash only"},{name:"Gusta Pizza",type:"Pizza",price:"E",tip:"Beste pizza Florence E9-12, to-go naar Piazzale"},{name:"Bambi Lampredotto",type:"Street food",price:"E",tip:"Viral broodje E3.50, con salsa verde e piccante"},{name:"I Fratellini",type:"Panini",price:"E",tip:"Sinds 1875, E3-5, korter dan Vinaio"},{name:"Osteria dell Enoteca",type:"Toscaans",price:"EE",tip:"Wild zwijn ragu"},{name:"Gelateria Dondoli",type:"Gelato",price:"E",tip:"San Gimignano, Wereld Kampioen, Crema di Santa Fina"}],viral:[{name:"All Antico Vinaio rij",desc:"1.6M likes, beroemdste sandwich ter wereld",tag:"@jacksdiningroom viral"},{name:"Lampredotto broodje",desc:"Florence street food, vierde maag in bouillon",tag:"@elizabeth_minchilli 8.4K"},{name:"Buchette del Vino (wijnraampjes)",desc:"Babae: spritz door 16e-eeuws luik E7-8",tag:"@italy_alfresco 46K likes"},{name:"Bistecca alla Fiorentina",desc:"2.6M+ TikTok posts, Mario of Sostanza",tag:"@briancantstopeating 71K"},{name:"Val d Orcia cipressen",desc:"Podere Belvedere + Poggio Covili, sunrise",tag:"UNESCO #tuscany"},{name:"Kookles Chianti",desc:"Pasta maken met wijn, E60-130pp",tag:"@giorgiacooking viral"},{name:"Gelateria Dondoli",desc:"Wereld Gelato Kampioen, San Gimignano",tag:"@thepasinis 13.7K likes"},{name:"Piazzale Michelangelo sunset",desc:"Pizza to-go van Gusta + sunset = viral combo",tag:"@gbennieats tip"}],transport:["Firenze SMN = hub","Bus San Gimignano via Poggibonsi","Auto voor Val d Orcia","ZTL boete = 150+!"]},
{id:"nap",name:"Napels",region:"Campanie",color:"#3d1f1a",lat:40.8518,lng:14.2681,zoom:13,intro:"Rauw, luid, echt. Pizza, Pompei, Vesuvius.",history:"Napels is een van de oudste steden van Europa, gesticht door Grieken als Neapolis. Hoofdstad van het Koninkrijk der Twee Sicilien. Pompei werd in 79 na Chr bedolven onder de Vesuvius.",budget:"Goedkoopste stad op de route! Pizza E4-8, lunch E8-15, diner E15-30. Metro E1.30. Pompei E18. Cash is koning.",safety:"Reputatie is erger dan realiteit, maar wees alert. Geen sieraden dragen, rugzak voor. Niet in donkere steegjes 's nachts. Verkeer is chaotisch.",bookings:["Pompei: ticketone.it/pompei","Vesuvius: ticketone.it/vesuvio"],firstSteps:["Metro naar Toledo station","Loop Spaccanapoli west naar oost","Boek Pompei online","Cash meenemen"],spots:[{name:"Spaccanapoli",desc:"Hartader centrum",tip:"Ochtend = best"},{name:"Pompei",desc:"Bevroren stad",tip:"Online tickets vroeg"},{name:"Cappella Sansevero",desc:"Christus-sculptuur",tip:"Reserveer"},{name:"Vesuvius",desc:"Beklim de vulkaan",tip:"Combi-ticket"},{name:"Sotterranea",desc:"Ondergrondse tunnels",tip:"Elk half uur"}],restaurants:[{name:"Da Michele",type:"Pizza",price:"E",tip:"Beroemdste pizzeria ter wereld, slechts 2 keuzes E5-6"},{name:"Sorbillo",type:"Pizza",price:"E",tip:"Pizzameester, Margherita Bufala D.O.P. E8-9"},{name:"Di Matteo",type:"Pizza+frituur",price:"E",tip:"Clinton at hier! Margherita E3, frittatina E1"},{name:"Donato Con Mollica o Senza",type:"Broodjes",price:"E",tip:"4.3M TikTok volgers! Con mollica o senza? E4-8"},{name:"Da Nennella",type:"Napolitaans",price:"E",tip:"Zingende obers, dagmenu E15pp, geen reservering"},{name:"Tandem Ragu",type:"Ragu",price:"E",tip:"Cuzzetiello: brood gevuld met ragu E7-11"},{name:"La Masardona",type:"Pizza fritta",price:"E",tip:"Sinds 1945, pizza fritta vanaf E1"},{name:"Poppella",type:"Pasticceria",price:"E",tip:"Fiocco di Neve E1.50! Via Arena della Sanita"},{name:"Pintauro",type:"Sfogliatella",price:"E",tip:"Uitvinder sfogliatella sinds 1785, E2-3"}],viral:[{name:"Donato De Caprio",desc:"4.3M volgers, Con mollica o senza?! Via Pignasecca 29",tag:"@donatodecaprio3"},{name:"Da Michele pizza fold",desc:"1800 pizza's per dag, Eat Pray Love-locatie",tag:"@anna.viajandooo 9.7K"},{name:"Toledo Metro Station",desc:"Mooiste metrostation ter wereld, blauwe mozaieken",tag:"@tripioapp viral"},{name:"Fiocco di Neve Poppella",desc:"Geheime crema, slechts E1.50, Rione Sanita",tag:"@wonderlandalessia 4K"},{name:"Da Nennella chaos",desc:"Obers zingen, dansen, borden breken, E15 dagmenu",tag:"@trattoriadanennella 9.6K"},{name:"Sfogliatella bij Pintauro",desc:"927K likes op 1 video! Warm uit de oven E2",tag:"@pastrychef_am viral"},{name:"Spaccanapoli food walk",desc:"Pizza portafoglio E2-3 bij elke toonbank",tag:"TikTok food tour"},{name:"Cuzzetiello bij Tandem",desc:"Uitgehold brood gevuld met 8u-ragu",tag:"@tandem_ragu 22K IG"}],transport:["Metro Lijn 1 Toledo!","Circumvesuviana Pompei E4","Alibus luchthaven E5"]},
{id:"ama",name:"Amalfikust",region:"Campanie",color:"#1a3040",lat:40.6333,lng:14.6029,zoom:12,intro:"Pastelkliffen, azuurblauwe zee, citroenen overal.",history:"De Amalfikust was in de middeleeuwen een machtige zeerepubliek die handelde met de Arabische wereld. Positano was een arm vissersdorp tot John Steinbeck er in 1953 over schreef. Ravello was favoriet van Wagner.",budget:"Duurste plek op de route. Lunch E15-25, diner E35-60. Veerboot E10-15 per rit. Strandbed E15-25/dag. Budget tip: eet in Atrani.",safety:"Veilig maar fysiek uitdagend. Steile trappen overal. SITA-bussen zijn vol in het seizoen. Geen auto - parkeren onmogelijk. Zon is intens, neem zonnebrand.",bookings:["Sentiero degli Dei: geen ticket nodig","Veerboot: travelmar.it"],firstSteps:["SITA-bus kaartjes bij tabacchi","Veerboot = sneller + mooier","GOEDE schoenen trappen!","Sentiero degli Dei: start vroeg"],spots:[{name:"Positano",desc:"Kleurendorp aan klif",tip:"Comfy schoenen"},{name:"Sentiero degli Dei",desc:"Pad der Goden 7km",tip:"Vroeg + 2L water"},{name:"Ravello",desc:"Tuinen + uitzicht",tip:"Rustiger"},{name:"Amalfi Duomo",desc:"Kathedraal + trap",tip:"Gratis entree"}],restaurants:[{name:"Da Adolfo",type:"Strandrestaurant",price:"EE",tip:"Alleen per boot! Rode vis-teken, mozzarella op citroenbladeren"},{name:"La Tagliata",type:"Familiemaaltijd",price:"EE",tip:"Geen menu, onbeperkt eten+wijn E60pp, shuttle"},{name:"Saraceno d Oro",type:"Pizza",price:"E",tip:"TikTok #1 betaalbaar Positano, pizza E10-15"},{name:"Le Arcate",type:"Vis/pizza",price:"E",tip:"In de rotswand Atrani, E15-30pp"},{name:"Andrea Pansa",type:"Pasticceria",price:"E",tip:"Delizia al limone sinds 1830, E3-6"},{name:"Il Ritrovo",type:"Seizoen",price:"EE",tip:"Kookles mogelijk!"}],viral:[{name:"Da Adolfo rode-visboot",desc:"Verborgen strandrestaurant, alleen per boot bereikbaar",tag:"@ckanani viral"},{name:"La Tagliata oneindig feest",desc:"Familie blijft gangen brengen tot je smeekt te stoppen",tag:"@clairerag beste restaurant"},{name:"Sentiero degli Dei",desc:"Pad der Goden 7km, Earth Premium unlocked",tag:"@justinefalconi 12.1K"},{name:"Villa Cimbrone Infinity Terrace",desc:"Ravello, marmeren balustrade panorama E10",tag:"@morettievents 278K likes"},{name:"Franco's Bar Le Sirenuse",desc:"Iconisch Positano uitzicht, cocktails E15-20",tag:"TikTok sunset spot"},{name:"Delizia al limone Pansa",desc:"Meest gefilmde dessert Amalfikust, sinds 1830",tag:"@stefano_zarrella 21K"},{name:"Citroen-sorbetto in citroen",desc:"Sorbetto in echte Sfusato Amalfitano citroen E3-5",tag:"TikTok viral shot"},{name:"Fiordo di Furore",desc:"Dramatische fjord-inham, too perfect to be real",tag:"Hidden gem #amalfi"}],transport:["SITA-bus langs kust","Veerboot Positano/Salerno","Geen auto!","Trein Napels naar Salerno"]},
